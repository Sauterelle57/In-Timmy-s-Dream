...
button_t *init_dialogue_interest(sfRenderWindow *window)
{
    ...
    interest[0] = create_interest("asset/example.png", (sfIntRect)
    {0, 0, 50, 50}, (sfVector2f){size.x * 0.21, size.y * 0.42}, &action);
    interest[1] = create_interest("asset/example.png", (sfIntRect)
...
button_t *init_dialogue_elem(sfRenderWindow *window)
{
    ...
    elem[0] = create_body("map/example.png", (sfIntRect){0, 0, 1920, 1080},
    (sfVector2f){size.x * 0, size.y * 0});
    elem[0] = create_body("map/example.png", (sfIntRect){0, 0, 50, 50},

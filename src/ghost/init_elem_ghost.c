...
static body_t *init_ghost_elem_2(body_t *elem)
{
    ...
    (sfVector2f){1020, -450});
    elem[9] = create_body("other/block.png", (sfIntRect){0, 0, 275, 220},
    (sfVector2f){670, 30});
    elem[10] = create_body("other/block.png", (sfIntRect){0, 0, 275, 220},
    (sfVector2f){1020, 30});
    elem[11] = create_body("other/block.png", (sfIntRect){0, 0, 50, 500},
    (sfVector2f){140, -700});
    elem[12] = create_body("other/block.png", (sfIntRect){0, 0, 50, 500},
    (sfVector2f){1910, -700});
    elem[13] = create_body("other/block.png", (sfIntRect){0, 0, 800, 50},
    (sfVector2f){1250, -325});
    elem[14] = create_body("other/block.png", (sfIntRect){0, 0, 600, 50},
    (sfVector2f){100, -325});
    elem[15] = create_body("other/block.png", (sfIntRect){0, 0, 45, 50},
    (sfVector2f){240, -525});
...
body_t *init_ghost_elem(sfRenderWindow *window, int nb_elem)
{
    ...
    2160}, (sfVector2f){0, 0});
    elem[1] = create_body("other/block.png", (sfIntRect){0, 0, 200, 50},
    (sfVector2f){850, 605});
    elem[2] = create_body("other/block.png", (sfIntRect){0, 0, 250, 80},
    (sfVector2f){1020, 570});
    elem[3] = create_body("other/block.png", (sfIntRect){0, 0, 250, 80},
    (sfVector2f){653, 570});
    elem[4] = create_body("other/block.png", (sfIntRect){0, 0, 50, 1000},
    (sfVector2f){675, -300});
    elem[5] = create_body("other/block.png", (sfIntRect){0, 0, 50, 1000},
    (sfVector2f){1210, -300});
    elem[6] = create_body("other/block.png", (sfIntRect){0, 0, 2000, 50},
    (sfVector2f){10, -600});
    elem[7] = create_body("other/block.png", (sfIntRect){0, 0, 275, 260},
    (sfVector2f){670, -450});

...
body_t *init_htp_elem_3(sfRenderWindow *window, int nb_elem,
body_t *elem, sfVector2u size)
{
...
body_t *init_htp_elem_2(sfRenderWindow *window, int nb_elem,
body_t *elem, sfVector2u size)
{
    ...
    (sfVector2f){550, 200});
    elem = init_htp_elem_3(window, nb_elem, elem, size);
    return (elem);
}
...
body_t *init_htp_elem(sfRenderWindow *window, int nb_elem)
{
    ...
    (sfVector2f){0, 0});
    elem = init_htp_elem_2(window, nb_elem, elem, size);
    return (elem);
}

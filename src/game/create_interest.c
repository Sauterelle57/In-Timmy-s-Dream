...
{
    interest[0] = create_interest(BAT[0], (sfIntRect){0, 0, 32, 32}, //chauve souris
    (sfVector2f){940, 540}, &go_combat);
    interest[1] = create_interest(NPC[0], (sfIntRect) //sorciere
    {0, 0, 32, 50}, (sfVector2f){2000, 500}, &example);
    ...
    {0, 0, 60, 70}, (sfVector2f){7940, 125}, &example);
    ...
    {0, 0, 60, 70}, (sfVector2f){6480, -1280}, &example);

...
{
    interest[12] = create_interest("other/blank.png", (sfIntRect) //porte maison hantée haut 3 avec citrouilles
    {0, 0, 60, 70}, (sfVector2f){7940, 125}, &go_ghost);
    interest[13] = create_interest("other/blank.png", (sfIntRect) //panneau tout en haut du chemin
    {0, 0, 40, 60}, (sfVector2f){7850, -2130}, &check_dialogue);
    interest[13].line = 18;
    interest[14] = create_interest("other/blank.png", (sfIntRect) //porte maison hantée avec jardin
    ...
    interest[18] = create_interest("object/Pickaxe.png", (sfIntRect) // Pickaxe
...
{
    interest[6] = create_interest("other/blank.png", (sfIntRect) //porte maison bas 2
    {0, 0, 60, 70}, (sfVector2f){6010, 970}, &go_room);
    interest[7] = create_interest("other/blank.png", (sfIntRect) //panneau spawn
    {0, 0, 40, 60}, (sfVector2f){4030, 760}, &check_dialogue);
    interest[7].line = 17;
    interest[8] = create_interest("other/blank.png", (sfIntRect) //porte maison hantée bas
    {0, 0, 60, 70}, (sfVector2f){7480, 1000}, &check_dialogue);
    interest[8].line = 1;
    interest[9] = create_interest("other/blank.png", (sfIntRect) //porte maison hantée milieu
    {0, 0, 60, 70}, (sfVector2f){7450, 580}, &check_dialogue);
    interest[9].line = 1;
    interest[10] = create_interest("other/blank.png", (sfIntRect) //porte maison hantée haut 1
    {0, 0, 60, 70}, (sfVector2f){6925, 140}, &check_dialogue);
    interest[10].line = 15;
    interest[11] = create_interest("other/blank.png", (sfIntRect) //porte maison hantée haut 2
...
{
    interest[0] = create_interest(BAT[(rand() % 3) * 3], (sfIntRect){0, 0, 48, //chauve souris
    ...
    interest[1].line = 2;
    interest[2] = create_interest("other/blank.png", (sfIntRect) //porte maison vampire
    {0, 0, 60, 70}, (sfVector2f){3750, 320}, &go_vampire);
    interest[3] = create_interest("other/blank.png", (sfIntRect) //porte maison haut 1
    {0, 0, 60, 70}, (sfVector2f){5220, 440}, &go_room);
    interest[4] = create_interest("other/blank.png", (sfIntRect) //porte maison haut 2
    {0, 0, 60, 70}, (sfVector2f){5740, 440}, &go_room);
    interest[5] = create_interest("other/blank.png", (sfIntRect) //porte maison bas 1
